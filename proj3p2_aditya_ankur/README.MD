...
7.  cd into astar_nh_ankur_aditya package 
8.  Run the following command "rosrun astar_nh_ankur_aditya robot_publisher.py" in another terminal which simulates turtlebot3 navigation
